...
<el-container style="height: 100vh; ">
  <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
    <!-- :default-active 根据路由里面的路径来高亮对应的菜单 -->
    <el-menu router :default-openeds="['3']" unique-opened :default-active="$route.path">
      <el-submenu index="1">
        <template slot="title"><i class="el-icon-message"></i>内容管理</template>
        <el-menu-item-group>
          <template slot="title">记录</template>
          <el-menu-item index="/vcards/create">新建记录</el-menu-item>
          <el-menu-item index="/vcards/list">记录列表</el-menu-item>
        </el-menu-item-group>
        <el-menu-item-group>
  ...
  <el-container>
    ...
    <el-main>
      <!-- 默认以组件区分，需要加：key表示用route.path路由的路径来区分,修复了点完编辑再点新建时输入框有数据的bug -->
